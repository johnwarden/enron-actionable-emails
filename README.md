This is an exercise in using machine learning to classify emails as "actionable" or "not actionable", using the Enron email corpus as training and test data.
